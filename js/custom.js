...
$(document).ready(function () {
    ...
    for(var i = 0; i < obj.education.colleges.length; i++) {
        edutext += '<tr><td style="align:center"><img src="' +
        ...
        for(var j=0; j< obj.education.colleges[i].courses.length; j++){
            coursetext +='<tr><td>'+obj.education.colleges[i].courses[j]+'</td></tr>';
        }
    ...
    for(var i = 0; i < obj.education.others.length; i++) {
        ...
        for(var j=0; j< obj.education.others[i].courses.length; j++){
            coursetext +='<tr><td>'+obj.education.others[i].courses[j]+'</td></tr>';
        }
        coursetext+='<tr><td>etc.</td></tr></table></div>'
    }
    ...
    for(var i = 0; i < obj.experience.works.length; i++) {
        exptext += '<div><div class="col-lg-5 col-md-6 col-sm-6 col-xs-6"><B>'+
            ...
            '" target="_blank"><i class="fa fa-fw fa-github"></i></a><button class="btn btn-default btn-xs btn-more" type="button" data-toggle="collapse" data-target="#collapseExp'+ i +
        ...
        for(var j=0; j<obj.experience.works[i].images.length;j++){
            ...
            exptext+='carousel-img-container"><a data-toggle="modal" data-target="#myModal" data-src="'+
                ...
                '"><img src="" alt="" style="background-image:url('+
                obj.experience.works[i].images[j]+
    ...
    for(var i = 0; i < obj.experience.projects.length; i++) {
        projecttext += '<div class="col-lg-10 col-md-11 col-sm-12 col-xs-12"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><B>' +
            ...
            '"><i class="fa fa-fw fa-github"></i></a></div><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-sm-offset-1 col-xs-offset-1">' +
            obj.experience.projects[i].description +
            '</div></div>'
            ;
    }
    ...
    var mail = "bHlkQHRhbXUuZWR1", phone = "OTc5NTcxODg2MA==", phoneo = "KDk3OSkgNTcxLTg4NjA=", text = "tel:" + atob(phone);
    ...
    if ($(window).width() < 768) {
        setTimeout(function () {$("#sidebar-toggled").collapse('show'); }, 500);
    }
});

var image = '<a target="_blank" href="http://weixin.qq.com/r/uvu2rtjE_IWHrZzN966o"><img class="img-responsive img-thumbnail qr" src="img/wechat.jpg" style="width:180px;"></a>';

$('#wechat').popover({placement: 'bottom', content: image, html: true});
...
$('#myModal').on('show.bs.modal', function (event) {
    var button = $(event.relatedTarget), src = button.data('src'), modal = $(this);
